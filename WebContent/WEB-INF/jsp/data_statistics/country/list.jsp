...
<c:set var="_pageTitle" value="国家区域数据" scope="request"/>
<c:set var="_underCountryData" value="active" scope="request"/>
<c:set var="_activeStatistics" value="active" scope="request"/>
<c:set var="_module" value="statistics" scope="request"/>
<c:import url="../../theme/${_theme}/header.jsp"></c:import>
<!-- main content -->
	<div class="page-header"><h1>国家区域数据</h1></div>
	<c:import url="search.jsp">
	</c:import>
    <form style="display: none" id="link_node_form" action="${basePath}data_statistics/country/list" method="POST">
    </form>
		<div id="list">
		...
		<div class="row-fluid">
            <div class="span4 toolbar">
            	<c:import url="../../theme/${_theme}/toolbar.jsp">
					<c:param name="modify">${basePath}data_statistics/country/modify</c:param>
				</c:import></div>
...
<script>
    ...
    function doExport(){
    	document.getElementById("search_form").action="${basePath}data_statistics/country/export";
    	document.getElementById("search_form").submit();
    }
    function doQuery(){
    	document.getElementById("search_form").action="${basePath}data_statistics/country/list";
    	document.getElementById("search_form").submit();
    }
</script>
