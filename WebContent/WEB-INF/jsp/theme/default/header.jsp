<%@page import="com.zhanghui.pusher.common.SystemUserType"%>
<%@page import="com.zhanghui.pusher.common.LoginContext"%>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="${basePath}">PUSH后台</a>
          <div class="nav-collapse collapse">
            <p class="navbar-text pull-right">
              ${pusher:username()}，您好！ <a href="${basePath}logout" class="navbar-link">退出</a>
            </p>
            <ul class="nav">
            <%SystemUserType sut=LoginContext.get().systemUserType;
            if(sut==SystemUserType.ADMIN) {%>
                <li class="${_activeAdv}"><a href="${basePath}adv/app/list">广告</a></li>
                <li class="${_activePush}"><a href="${basePath}push/task/list">推送</a></li>
                <li class="${_activeUser}"><a href="${basePath}user/list">用户</a></li>
                <li class="${_activeBrowser}"><a href="${basePath}browser/settings/list">浏览器</a></li>
                ...
                <li class="${_activeStatistics}"><a href="${basePath}pv/chart">统计</a></li>
                <%} %>
