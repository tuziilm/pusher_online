...
function start_tomcat(){
        echo "start tomcat..."
        export CATALINA_OPTS='-Xss256K -DappName=pusher -server -XX:+DisableExplicitGC -XX:+PrintFlagsFinal -XX:+UseConcMarkSweepGC -Xmx2g -Xms2g -XX:NewSize=1g -XX:PermSize=48m -XX:MaxPermSize=96m -Xloggc:/data/pusher/work/logs/tomcat/gc.log -XX:+PrintGCDetails -XX:+PrintGCTimeStamps' # -Xdebug -Xrunjdwp:transport=dt_socket,address=38787,server=y,suspend=n'
